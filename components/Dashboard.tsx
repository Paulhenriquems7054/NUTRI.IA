          ...
          <div className="p-6">
            ...
            <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
              ...
              <div className="p-4 bg-rose-100 dark:bg-rose-900/50 rounded-lg">
                <p className="text-sm text-rose-600 dark:text-rose-300">Proteínas</p>
                <p className="text-2xl font-bold text-rose-800 dark:text-rose-200">{summary.total_proteinas_g}g</p>
              </div>
              <div className="p-4 bg-amber-100 dark:bg-amber-900/50 rounded-lg">
                <p className="text-sm text-amber-600 dark:text-amber-300">Carboidratos</p>
                <p className="text-2xl font-bold text-amber-800 dark:text-amber-200">{summary.total_carboidratos_g}g</p>
              </div>
              <div className="p-4 bg-indigo-100 dark:bg-indigo-900/50 rounded-lg">
                <p className="text-sm text-indigo-600 dark:text-indigo-300">Gorduras</p>
                <p className="text-2xl font-bold text-indigo-800 dark:text-indigo-200">{summary.total_gorduras_g}g</p>
              </div>
            </div>
          </div>
        </Card>
