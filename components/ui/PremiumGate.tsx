  ...
  return (
    <Card className="border-2 border-amber-400 bg-gradient-to-br from-amber-50 to-yellow-50 dark:from-amber-900/20 dark:to-yellow-900/20">
      <div className="text-center p-8 md:p-12">
        ...
        {limitMessage && (
          <p className="text-sm text-amber-700 dark:text-amber-300 mb-6 font-semibold">
            {limitMessage}
          </p>
        )}
        {showUpgradeButton && (
          <div className="mt-8">
            <Button 
              ...
              className="bg-gradient-to-r from-primary-600 to-amber-500 hover:from-primary-700 hover:to-amber-600 text-white font-bold shadow-lg hover:shadow-xl transition-all duration-300"
              size="lg"
            >
